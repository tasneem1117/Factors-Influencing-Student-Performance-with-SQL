...
if page == "Dashboard":
    ...
    if student_id_input:
        ...
        if not student_data.empty:
            ...
            if student["attendance_percentage"] < 75:
                ...
                insights.append(
                    "• ⚠️ Critical Alert: Attendance is below 75%. Absenteeism might be heavily dampening comprehension."
                )
    ...
    st.header("AI Exam Score Prediction")
    ...
    if st.button("Predict Exam Score", use_container_width=True):
        ...
        if prediction >= 85:
            ...
            st.success(
                "Excellent! This student is predicted to perform exceptionally well."
            )
            ...
            st.error(
                "High academic risk. Consider improving study habits and attendance."
            )